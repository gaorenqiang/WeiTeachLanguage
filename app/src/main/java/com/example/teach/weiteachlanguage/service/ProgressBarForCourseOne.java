 ...
 */
public class ProgressBarForCourseOne extends AsyncTask<String, Integer, String> {
     ...
     */
    public ProgressBarForCourseOne(Context context, TextView textInfo, ProgressBar bar) {
    ...
    只是用于测试进度条
     */
    public ProgressBarForCourseOne(Context context, ProgressBar bar) {
        this.bar = bar;
        this.mContext=context;
    }
